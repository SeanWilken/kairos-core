      ...
      {state.gen_status === "done" && state.artifacts.length > 0 && (
        <div className="space-y-4">
          <div className="rounded-lg border border-blue-200 bg-blue-50 p-4 text-xs text-blue-900 leading-relaxed">
            ...
            <p className="mt-1">Recommended: place generated files in a <code className="font-mono bg-blue-100 px-1 rounded">myai-suite</code> subfolder at the repository root, rename <code className="font-mono bg-blue-100 px-1 rounded">.env.template</code> to <code className="font-mono bg-blue-100 px-1 rounded">.env</code>, then run <code className="font-mono bg-blue-100 px-1 rounded">bootstrap-local</code>. In local-source mode this builds Core from <code className="font-mono bg-blue-100 px-1 rounded">../backend/Dockerfile</code>; image modes use <code className="font-mono bg-blue-100 px-1 rounded">CORE_API_IMAGE</code>. Keep the repository migration runners and <code className="font-mono bg-blue-100 px-1 rounded">migrations/</code> directory in the parent root.</p>
